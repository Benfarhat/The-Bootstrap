...
function the_bootstrap_settings_field_navbar() {
	...
	?>
	<div style="border:1px solid #ddd;border-radius:4px;background-color:#eee; padding:8px;margin:6px 0;">
	<label for="navbar-site-name"><?php _e( 'Add site name to navigation bar.', 'the-bootstrap' );  ?></label>
		...
		<br />
	<label for="navbar-site-name-content"><?php _e( 'Custom site name or message to navigation bar.', 'the-bootstrap' );  ?></label>
		<input type="text" style="width:60%" name="the_bootstrap_theme_options[navbar_site_name_content]" id="navbar-site-name-content" value="<?php  echo (the_bootstrap_get_theme_options()->navbar_site_name_content ); ?>" <?php if(empty(the_bootstrap_get_theme_options()->navbar_site_name_content)): ?>placeholder="<?php _e( 'Custom site name or message to navigation bar.', 'the-bootstrap' );  ?>..."<?php endif;?> />
<br />
	...
	<div style="border:1px solid #ddd;border-radius:4px;background-color:#eee; padding:8px;margin:6px 0;">
	<label for="custom-style-site"><?php _e( 'choose ur style!.', 'the-bootstrap' );  ?></label>
